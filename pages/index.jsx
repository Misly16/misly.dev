    ...
    <div className='mx-auto max-w-4xl py-10 px-5'>
      ...
      <div className='mx-auto max-w-4xl py-20 px-4 space-y-12'>
        ...
        <div className='space-y-4'>
          ...
          <p className='text-lg leading-6 tracking-wide text-gray-200 font-light'>I am passionate about technology, from hardware and embedded systems to developing efficient and scalable software. I&apos;m currently working with <Link className='underline' href='https://playcap.app/' target='_blank'>Playcap</Link> where we&apos;re building software targeted at the gaming industry.</p>
        </div>
        <div className='space-y-4'>
